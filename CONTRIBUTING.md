環境設定の詳細については、[README.md](README.md)ファイルを参照してください。
...
- プロジェクトの管理者(rynan4818[リュナン])は英語が話せないため、英語の読み書きは翻訳ツールを使用します。
変な英文になると思いますが、ご了承下さい。可能な方は日本語で投稿をお願いします。
----------------------------------------------------------------------------------------
For details on how to set up your environment, see the [README.md](README.md) file.

Before opening a pull request please make sure that:

- The code you're submitting builds.

- The character code is UTF-8 without BOM.
